...
import '../model_edu/model_berita.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      http.Response response = await http.get(
          Uri.parse("http://192.168.1.24/edukasi_server/getBerita.php"));
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          }, child: Text('Hi ${sessionManager.userName ?? 'nabila23'}')),
          //logout
                                ...
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Center(
                                      child: Image.network(
                                        'http://'
                                            '10.127.249.116/edukasi_server/gambar_berita/${data
                                            .gambar}',
                                        width: 250,
                                        height: 300,
                                        fit: BoxFit.cover,
        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(10),
              child: Image.network(
                'http://10.127.249.116/edukasi_server/gambar_berita/${data?.gambar}',
                height: 300,
                fit: BoxFit.fill,
              ),
            ),
